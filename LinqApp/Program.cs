...
namespace LinqApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("--");
            evenNums.ToList().ForEach(Console.WriteLine);

            /*ist<int> evensOrderedDesc = (from num in numbers
                                          where num % 2 == 0
            ...
            */
            ...
            // Reduce            
            var sum = numbers.Sum();     //var sum = numbers.Sum(n => n);
            ...
            Console.WriteLine("All GT 0: " + allGT0);
